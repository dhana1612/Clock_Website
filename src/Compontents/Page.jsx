    ...
    <>
        <section className="py-22 md:py-42 bg-[url(https://preview.colorlib.com/theme/timezone/assets/img/hero/about_hero.png)]">
            <div className="flex justify-center">
                <h2 className='font-bold text-4xl md:text-7xl py-10 text-indigo-950 '>Pages</h2>
            </div>
        </section>
     ...
     <div className='flex justify-center py-15'>
        ...
        <section className='max-w-[85rem] mx-auto py-25 px-5'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>

          <div>
              <h1 className='font-bold text-3xl xl:text-5xl py-10'>Watch of Choice</h1>
